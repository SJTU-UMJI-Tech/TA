...
<link href="/ji_style/ta/application/student/stu_app_showmyapp.css" type="text/css" rel="stylesheet"/>
<script src="/ji_js/ta/application/student/stu_app_showmyapp.js"></script>
		...
		<tr>
			...
			<td class="mainbar">
				<?php foreach ($list as $item): ?>
					<?php /** @var Application_record_obj $item */ ?>
					<div class="text-container">
						<div class="personal-information">
							<table width="88%">
								<tr>
									<td width="44%" colspan="2">Course ID: <span
												class="info courseid"><?php echo ucfirst($item->course->KCDM); ?></span>
									</td>
								</tr>
								<tr>
								...
								<!--<tr>
									<td width="39%">Name: <span class="info"><?php /*echo ucwords($item->name); */?></span>
									</td>
									<td width="49%">Student ID: <span
												class="info studentid"><?php /*echo $item->student_id; */?></span></td>
								</tr>
								<tr>
...
<div class="box" id="reprocess-box">
	...
	<table width="80%" align="center">
		<td width="40%"><input type="submit" name="delete" align="center" value="Yes" class="submit" id="reprocess-yes"
